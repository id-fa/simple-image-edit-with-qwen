...
- Original filename display: Uploaded filenames are saved per job (`input_names` JSON array). Displayed only to the uploader (user_hash match). Download filenames are prefixed with the original filename for the owner
